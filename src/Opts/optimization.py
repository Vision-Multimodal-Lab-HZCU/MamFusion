...
class _LRSchedule(ABC):
    ...
    def get_lr(self, step, nowarn=False):
        ...
        if (
            ...
            logger.warning(
                "Training beyond specified 't_total'. Learning rate multiplier set to {}. Please "
                "set 't_total' of {} correctly.".format(
    ...
    def __call__(self, model, step):
        ...
        for name, param in model.named_parameters():
            if param.requires_grad:
                ...
                new_average = (1.0 - decay) * param.data + decay * self.shadow[
                    name
                ]
        ...
        **kwargs
        ...
        if not isinstance(schedule, _LRSchedule):
            ...
            if warmup != -1 or t_total != -1:
                logger.warning(
                    "warmup and t_total on the optimizer are ineffective when _LRSchedule object is "
