...
class validations(nn.Module):
    ...
    def forward(self, model, context_dataloader, query_eval_loader):
        ...
        score_sum, query_metas = self.compute_query2ctx_info(
    ...
    def compute_query2ctx_info(self, model, query_eval_loader, ctx_info):
        ...
        for idx, batch in tqdm(
            ...
            query_feat = batch[0]
            query_mask = batch[1]
            _clip_scale_scores, _frame_scale_scores = (
            ...
            _score_sum = (
                self.cfg["clip_scale_w"] * _clip_scale_scores
        ...
        def cat_tensor(tensor_list):
            if len(tensor_list) == 0:
                ...
                for i, e in enumerate(tensor_list):
                    res_tensor[
                        b_sizes_cumsum[i] : b_sizes_cumsum[i + 1], : seq_l[i]
                    ] = e
                return res_tensor
